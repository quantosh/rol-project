    ...
    <div className="max-w-fit ">
      <div className="bg-white border border-gray-200 rounded-lg shadow m-1 p-2">
        ...
        <div className="content-center align-middle justify-center">
          ...
          <button type="button" className="w-full mt-2 text-white bg-blue-700 hover:bg-blue-800 rounded-lg text-sm px-5 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Roll!</button>
        </div>
      </div>
